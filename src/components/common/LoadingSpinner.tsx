...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
  ...
  const spinnerTextStyle = [styles.text, textStyle];
...
export const FullScreenLoader: React.FC<{
  ...
  return (
    <LoadingSpinner size="large" color={color} text={text} overlay style={styles.fullScreen} />
  );
};
...
export const InlineLoader: React.FC<{
  ...
  return <LoadingSpinner size={size} color={color} style={styles.inline} />;
};
